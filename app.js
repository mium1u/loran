...
const loranChart = new Chart(ctx, {
    ...
    options: {
        responsive: false,  // Отключаем автоматическую подгонку размера
        scales: {
            x: {
                type: 'linear',
                position: 'bottom',
                min: 0,  // Устанавливаем минимальные и максимальные значения для оси x
                max: 100000
            },
            y: {
                type: 'linear',
                min: 0,  // Устанавливаем минимальные и максимальные значения для оси y
                max: 100000
            }
        }
    }
